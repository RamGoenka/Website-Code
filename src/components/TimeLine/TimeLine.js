...
const Timeline = () => {
  ...
  return (
    <Section nopadding id="Expereince">
      ...
      • Refactored code from SAS to Python using Pandas in order to modernize technology used for company-wide actuarial research. Added robust unit tests using PyTest to verify the written implementation.<br />
      • Researched Microsoft Bicep as a tool for infrastructure as code to deploy sample test Azure spring applications. Developed scripts using Microsoft Bicep and deployed them in a GitLab environment.<br />
      • Researched artificial intelligence (AI) models such as ChatGPT and their impacts on shaping the future of the insurance industry. Studied the uses, impacts and potential future of ChatGPT models within the insurance industry.<br />
      <br />
      <br />
